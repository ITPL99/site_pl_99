...
public class CourseController  {
    ...
    public ResponseEntity<List<CourseDtoResponse>> getByTitle(@RequestParam String title) {
        return ResponseEntity.ok(courseService.getByTitle(title).stream().map(CourseMapper::mapEntityToDtoResponse).collect(toList()));
    }
